...
function OptionList({ setOpen, setSelectedOption }: { setOpen: (open: boolean) => void; setSelectedOption: (option: Currency | null) => void }) {
  return (
    <Command>
      <CommandInput placeholder="Set Currency..." />
      <CommandList>
        ...
        <CommandGroup>
          {Currencies.map((item: Currency) => (
            <CommandItem
              ...
              value={item.value}
              onSelect={(value) => {
                setSelectedOption(Currencies.find((item) => item.value === value) || null);
                setOpen(false);
              }}
            >
              {item.label}
