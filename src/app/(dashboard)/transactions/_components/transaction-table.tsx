...
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuItem, DropdownMenuContent, DropdownMenuSeparator, DropdownMenuLabel } from "@/components/ui/dropdown-menu";
...
const columns: ColumnDef<TransactionHistoryRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <p className="text-md rounded-lg bg-gray-400/5 p-2 text-center font-medium">{row.original.formattedAmount}</p>,
  },
  {
    id: "actions",
    enableHiding: false,
...
function RowAction({ transaction }: { transaction: TransactionHistoryRow }) {
  ...
  return (
    <>
      <DeleteTransactionDialog open={showDeletedDialog} setOpen={setShowDeletedDialog} transactionId={transaction.id} />
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            ...
            onSelect={() => {
              setShowDeletedDialog((prev) => !prev);
            }}
          >
